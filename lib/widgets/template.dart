...
class BmiTemplate extends StatefulWidget {
  const BmiTemplate({Key? key}) : super(key: key);

  @override
  State<BmiTemplate> createState() => _BmiTemplateState();
}

class _BmiTemplateState extends State<BmiTemplate> {
